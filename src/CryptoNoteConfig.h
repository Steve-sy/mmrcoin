...
namespace parameters {
  ...
  const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x8; // addresses start with "mmr"
  ...
  const char     CRYPTONOTE_BLOCKS_FILENAME[]                  = "mmr-blocks.dat";
  const char     CRYPTONOTE_BLOCKINDEXES_FILENAME[]            = "mmr-blockindexes.dat";
  const char     CRYPTONOTE_BLOCKSCACHE_FILENAME[]             = "mmr-blockscache.dat";
  const char     CRYPTONOTE_POOLDATA_FILENAME[]                = "mmr-poolstate.bin";
  const char     P2P_NET_DATA_FILENAME[]                       = "mmr-p2pstate.bin";
  const char     CRYPTONOTE_BLOCKCHAIN_INDICES_FILENAME[]      = "mmr-blockchainindices.dat";
  const char     MINER_CONFIG_FILE_NAME[]                      = "mmr-miner_conf.json";
  } // parameters
...
const int      RPC_DEFAULT_PORT                              = 15237;
...
const std::initializer_list<const char*> SEED_NODES = {
   "185.127.18.101:15236",
   "176.88.131.228:15236"
};
